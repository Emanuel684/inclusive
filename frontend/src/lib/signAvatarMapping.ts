...
const LEX_CLIP_BY_SLUG: Record<string, readonly string[]> = {
  ...
  como: ['Yes', 'Wave', 'ThumbsUp'],
  estas: ['ThumbsUp', 'Wave', 'Yes'],
  esta: ['Yes', 'No', 'Wave'],
  estan: ['Wave', 'Running', 'Yes'],
  tu: ['ThumbsUp', 'Punch', 'Wave'],
  usted: ['Yes', 'Walking', 'ThumbsUp'],
  bien: ['ThumbsUp', 'Jump', 'Yes'],
  mal: ['No', 'Punch', 'Wave'],
  si: ['Yes', 'Dance', 'ThumbsUp'],
  no: ['No', 'Wave', 'Punch'],
  por: ['Walking', 'Yes', 'Wave'],
  favor: ['ThumbsUp', 'Wave', 'Jump'],
  que: ['Wave', 'Yes', 'No'],
  quien: ['Jump', 'ThumbsUp', 'Wave'],
  donde: ['Walking', 'Wave', 'Yes'],
  cuando: ['Dance', 'Wave', 'ThumbsUp'],
  mucho: ['ThumbsUp', 'Running', 'Wave'],
  poco: ['Wave', 'No', 'Yes'],
  yo: ['Yes', 'Wave', 'ThumbsUp'],
  nosotros: ['Wave', 'Walking', 'ThumbsUp'],
  ellos: ['Running', 'Wave', 'Yes'],
  ellas: ['Dance', 'ThumbsUp', 'Wave'],
  el: ['Wave', 'Yes', 'Walking'],
  ella: ['ThumbsUp', 'Wave', 'Jump'],
  unos: ['Yes', 'Wave', 'Punch'],
  unas: ['ThumbsUp', 'Dance', 'Wave'],
  porque: ['No', 'Yes', 'Wave'],
  pero: ['Punch', 'Wave', 'ThumbsUp'],
  disculpa: ['Wave', 'ThumbsUp', 'Yes'],
  perdon: ['ThumbsUp', 'No', 'Wave'],
  placer: ['Yes', 'ThumbsUp', 'Dance'],
  encantado: ['Wave', 'Jump', 'ThumbsUp'],
  encantada: ['ThumbsUp', 'Wave', 'Dance'],
}
